...
class DatabaseReturnForm(forms.Form):
    """Select a return type and period for database-generated returns."""
...
class ChildReturnDetailsForm(forms.Form):
    """Child details required for a mother in a generated child return."""
    name = forms.CharField(max_length=200, label='Child name')
    age = forms.CharField(max_length=50, label='Child age')
    sex = forms.ChoiceField(choices=[('M', 'Male'), ('F', 'Female')], label='Child sex')
