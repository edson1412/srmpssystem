...
# Email notifications. Use the console backend during local development;
# configure SMTP environment variables for real delivery.
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'Prison MS <noreply@example.com>')
