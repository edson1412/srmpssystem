...
from crispy_forms.templatetags.crispy_forms_filters import as_crispy_field as crispy_as_crispy_field
...
def as_crispy_field(field):
    """Render a bound form field using the configured crispy template pack."""
    return crispy_as_crispy_field(field)
